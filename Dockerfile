...
RUN apt-get update && \
    apt-get upgrade -y && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y git curl wget ca-certificates supervisor openjdk-17-jdk ansible && \
...
ARG JENKINS_VERSION
ENV JENKINS_VERSION ${JENKINS_VERSION:-2.380}

# jenkins.war checksum, download will be validated using it
ARG JENKINS_SHA=9b642cd407b1ea9b3f90c0f54d7d42b7aa5fdcd42cba317e375a308a398d71d4
